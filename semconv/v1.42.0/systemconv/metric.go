...
type FileLockTypeAttr string

var (
	FileLockTypeRead FileLockTypeAttr = "read"

	FileLockTypeWrite FileLockTypeAttr = "write"
)
...
type FilesystemLockCount struct {
	metric.Int64UpDownCounter
}

var newFilesystemLockCountOpts = []metric.Int64UpDownCounterOption{
	metric.WithDescription("Filesystem lock counts."),
	metric.WithUnit("{lock}"),
}

func NewFilesystemLockCount(
	m metric.Meter,
	opt ...metric.Int64UpDownCounterOption,
) (FilesystemLockCount, error) {
	_ = "STUB: not implemented"
	return *new(FilesystemLockCount), nil
}

func (m FilesystemLockCount) Inst() metric.Int64UpDownCounter {
	_ = "STUB: not implemented"
	return *new(metric.Int64UpDownCounter)
}

func (FilesystemLockCount) Name() string { _ = "STUB: not implemented"; return "" }

func (FilesystemLockCount) Unit() string { _ = "STUB: not implemented"; return "" }

func (FilesystemLockCount) Description() string { _ = "STUB: not implemented"; return "" }

func (m FilesystemLockCount) Add(
	ctx context.Context,
	incr int64,
	attrs ...attribute.KeyValue,
) {
...
func (m FilesystemLockCount) AddSet(ctx context.Context, incr int64, set attribute.Set) {
	_ = "STUB: not implemented"
	return
}

func (FilesystemLockCount) AttrFileLockMechanism(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCount) AttrFileLockMode(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCount) AttrFileLockType(val FileLockTypeAttr) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCount) AttrDevice(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

type FilesystemLockCountObservable struct {
	metric.Int64ObservableUpDownCounter
}

var newFilesystemLockCountObservableOpts = []metric.Int64ObservableUpDownCounterOption{
	metric.WithDescription("Filesystem lock counts."),
	metric.WithUnit("{lock}"),
}

func NewFilesystemLockCountObservable(
	m metric.Meter,
	opt ...metric.Int64ObservableUpDownCounterOption,
) (FilesystemLockCountObservable, error) {
	_ = "STUB: not implemented"
	return *new(FilesystemLockCountObservable), nil
}

func (m FilesystemLockCountObservable) Inst() metric.Int64ObservableUpDownCounter {
	_ = "STUB: not implemented"
	return *new(metric.Int64ObservableUpDownCounter)
}

func (FilesystemLockCountObservable) Name() string { _ = "STUB: not implemented"; return "" }

func (FilesystemLockCountObservable) Unit() string { _ = "STUB: not implemented"; return "" }

func (FilesystemLockCountObservable) Description() string { _ = "STUB: not implemented"; return "" }

func (FilesystemLockCountObservable) AttrFileLockMechanism(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCountObservable) AttrFileLockMode(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCountObservable) AttrFileLockType(val FileLockTypeAttr) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}

func (FilesystemLockCountObservable) AttrDevice(val string) attribute.KeyValue {
	_ = "STUB: not implemented"
	return *new(attribute.KeyValue)
}
